...
-- --     insert into hibernate_sequence values ( 1 );
CREATE TABLE IF NOT EXISTS member (member_id bigint not null auto_increment, created_date datetime(6), modified_date datetime(6), account_name varchar(255) not null, email varchar(255) not null, introduce varchar(255), is_working varchar(255) not null, nickname varchar(255) not null, password varchar(255) not null, role varchar(255) not null, years integer not null, member_info_id bigint, salt varchar(255) not null, category varchar(255) not null, primary key (member_id));

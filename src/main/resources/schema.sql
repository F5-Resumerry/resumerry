...
CREATE TABLE IF NOT EXISTS post (post_id bigint not null auto_increment, created_date timestamp NULL DEFAULT CURRENT_TIMESTAMP, modified_date timestamp NULL DEFAULT CURRENT_TIMESTAMP, category varchar(255) not null, contents varchar(255) not null, is_anonymous varchar(255) not null, title varchar(255) not null, views integer not null, member_id bigint, resume_id bigint,is_delete varchar(50) NOT NULL DEFAULT 'N', primary key (post_id));
CREATE TABLE IF NOT EXISTS post_comment (post_comment_id bigint not null auto_increment, created_date timestamp NULL DEFAULT CURRENT_TIMESTAMP, modified_date timestamp NULL DEFAULT CURRENT_TIMESTAMP, contents varchar(255) not null, is_anonymous varchar(255) not null, post_comment_depth integer not null, post_comment_group integer not null, member_id bigint, post_id bigint, is_delete varchar(50) NOT NULL DEFAULT 'N', primary key (post_comment_id));

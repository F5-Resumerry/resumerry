...
>>>>>>> 6b4bd1898e4aede7fa1002b3220f79146512f625
...
CREATE TABLE IF NOT EXISTS resume (resume_id bigint not null, created_date datetime(6), modified_date datetime(6), category integer not null, contents varchar(255), file_link varchar(255) not null, title varchar(255) not null, views integer not null, years integer not null, member_id bigint, primary key (resume_id));
CREATE TABLE IF NOT EXISTS resume_comment (resume_comment_id bigint not null, created_date datetime(6), modified_date datetime(6), contents varchar(255) not null, is_anonymous varchar(255) not null, resume_comment_depth integer not null, resume_comment_group integer not null, member_id bigint, resume_id bigint, primary key (resume_comment_id));
CREATE TABLE IF NOT EXISTS resume_comment_recommend (resume_comment_recommend_id bigint not null, member_id bigint, resume_comment_id bigint, primary key (resume_comment_recommend_id));
CREATE TABLE IF NOT EXISTS resume_comment_report (resume_comment_report_id bigint not null, member_id bigint, resume_comment_id bigint, primary key (resume_comment_report_id));
CREATE TABLE IF NOT EXISTS resume_hashtag (resume_hashtag_id bigint not null, hashtag_id bigint, resume_id bigint, primary key (resume_hashtag_id));
CREATE TABLE IF NOT EXISTS resume_recommend (resume_recommend_id bigint not null, member_id bigint, resume_id bigint, primary key (resume_recommend_id));
CREATE TABLE IF NOT EXISTS resume_scrap (resume_scrap_id bigint not null, created_date datetime(6) not null, member_id bigint, resume_id bigint, primary key (resume_scrap_id));
CREATE TABLE IF NOT EXISTS token_history (token_history_id bigint not null, count bigint not null, created_date datetime(6) not null, reason varchar(255) not null, member_id bigint, primary key (token_history_id));
>>>>>>> 6b4bd1898e4aede7fa1002b3220f79146512f625

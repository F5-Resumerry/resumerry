...
CREATE TABLE IF NOT EXISTS member (member_id bigint not null, created_date datetime(6), modified_date datetime(6), account_name varchar(255) not null, email varchar(255) not null, introduce varchar(255), is_working varchar(255) not null, nickname varchar(255) not null, password varchar(255) not null, role integer not null, years integer not null, member_info_id bigint, primary key (member_id))
...
CREATE TABLE IF NOT EXISTS member_info (member_info_id bigint not null, email_verified varchar(255), image_src_l varchar(255) not null, image_src_m varchar(255) not null, image_src_s varchar(255) not null, receive_advertisement varchar(255), stack integer not null, token integer not null, primary key (member_info_id))
...
CREATE TABLE IF NOT EXISTS post (post_id bigint not null, created_date datetime(6), modified_date datetime(6), contents varchar(255) not null, is_anonymous varchar(255) not null, title varchar(255) not null, views integer not null, member_id bigint, resume_id bigint, primary key (post_id))
CREATE TABLE IF NOT EXISTS post_category (post_category_id bigint not null, category_id bigint, post_id bigint, primary key (post_category_id))
...
CREATE TABLE IF NOT EXISTS resume (resume_id bigint not null, created_date datetime(6), modified_date datetime(6), contents varchar(255), file_link varchar(255) not null, title varchar(255) not null, views integer not null, years integer not null, member_id bigint, primary key (resume_id))
CREATE TABLE IF NOT EXISTS resume_category (resume_category_id bigint not null, category_id bigint, resume_id bigint, primary key (resume_category_id))

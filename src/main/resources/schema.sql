...
-- --     insert into hibernate_sequence values ( 1 );
CREATE TABLE IF NOT EXISTS member (member_id bigint not null auto_increment, created_date datetime(6), modified_date datetime(6), account_name varchar(255) not null, email varchar(255) not null, introduce varchar(255), is_working varchar(255) not null, nickname varchar(255) not null, password varchar(255) not null, role varchar(255) not null, years integer not null, member_info_id bigint references member_info(member_info_id), salt varchar(255) not null, category varchar(255) not null, is_delete varchar(255) not null, image_src varchar(255), primary key (member_id));
CREATE TABLE IF NOT EXISTS member_info (member_info_id bigint not null auto_increment, email_verified varchar(255), receive_advertisement varchar(255), stack integer not null, token integer not null, primary key (member_info_id));
...
CREATE TABLE IF NOT EXISTS post (post_id bigint not null auto_increment, created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, modified_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP , category varchar(255) not null, contents varchar(255) not null, is_anonymous varchar(255) not null, title varchar(255) not null, viewCnt integer not null, member_id bigint references member(member_id), resume_id bigint references resume(resume_id), is_delete varchar(255) not null , primary key (post_id));
...
CREATE TABLE IF NOT EXISTS resume (resume_id bigint not null auto_increment, created_date datetime(6), modified_date datetime(6), category integer not null, contents varchar(255), file_link varchar(255) not null, title varchar(255) not null, viewCnt integer not null, years integer not null, member_id bigint, is_delete varchar(255) not null, primary key (resume_id));
